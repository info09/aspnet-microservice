...
namespace Infrastructure.Identity
{
    public static class ConfigureAuthAuthorHandler
    {
        ...
        {
            var configuration = services.GetOptions<ApiConfiguration>(nameof(ApiConfiguration));
            ...
            services.AddAuthentication(IdentityServerAuthenticationDefaults.AuthenticationScheme).AddIdentityServerAuthentication(opt =>
            {
